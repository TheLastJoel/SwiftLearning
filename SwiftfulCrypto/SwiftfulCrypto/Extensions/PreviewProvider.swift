...
extension PreviewProvider{
    ...
    // This is a way to access a singleton
...
class DeveloperPreview{
    ...
    // Always make the init private when you want a singleton so it cannot be accessed from outside the class
    private init(){
    ...
    let stat = Statistic(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
